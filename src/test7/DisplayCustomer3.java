...
/**
 * Program description : a GUI for display customer counter 3 
 *
...
//driver method
public class DisplayCustomer3 extends JFrame{
    //private variable declaration
    private JScrollPane scrollPane;
    private final JPanel panel = new JPanel();//for its value cannot be changed
    private static JTable table;
    private JButton btnNewButton;
    
    //to set the display tablefor customer counter 3
    public DisplayCustomer3(String titleFrame, int counternumber) {
        initialize(titleFrame, counternumber);
    }

    // to initialize the contents of the frame
    private void initialize(String titleFrame, int counternumber) {
        ...
        btnNewButton.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    if(CounterGui.getQueueCounter3().size() < 1) {
