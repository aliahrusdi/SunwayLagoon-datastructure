...
/**
 * Program description : a GUI for display customer counter 1
 *
...
public class DisplayCustomer extends JFrame{
    ...
    //to set the display tablefor customer counter 1
    public DisplayCustomer(String titleFrame, int counternumber) {
    ...
    private void initialize(String titleFrame, int counternumber) {
        ...
        btnNewButton.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    //display message if no customer
                    if(CounterGui.getQueueCounter1().size() < 1) {
